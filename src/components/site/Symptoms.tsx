...
export const Symptoms = () => (
  <section id="sintomas" className="py-24 sm:py-32 bg-secondary">
    <div className="container">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-16">
        {items.map((item, i) => (
          <div
            key={item.title}
            className="reveal group relative bg-card rounded-2xl p-8 shadow-soft hover:shadow-elegant border border-border/60 hover:border-gold/40 transition-all duration-500"
            style={{ transitionDelay: `${i * 60}ms` }}
          >
            <div className="w-14 h-14 rounded-xl bg-navy text-gold grid place-items-center text-2xl mb-5 group-hover:bg-gradient-gold group-hover:text-navy-deep transition-all duration-500">
