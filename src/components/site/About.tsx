  ...
  <section id="sobre" className="py-24 sm:py-32 bg-background">
    <div className="container grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
      ...
      <div className="reveal relative max-w-md mx-auto lg:mx-0 w-full">
        <div className="absolute -inset-4 sm:-inset-6 border-2 border-gold rounded-2xl translate-x-5 translate-y-5" />
        <img
          src={drImg}
        ...
        />
        <div className="absolute -bottom-6 -left-6 bg-navy-deep text-white px-6 py-4 rounded-xl shadow-elegant border border-gold/30">
          <div className="text-gold font-display text-2xl">15+</div>
          <div className="text-xs uppercase tracking-widest text-white/70">anos de carreira</div>
        </div>
      </div>

      {/* Content */}
      <div className="reveal">
        <p className="inline-flex items-center gap-3 text-xs tracking-[0.3em] uppercase text-gold-dark mb-4">
          <span className="w-8 h-px bg-gold" /> Sobre o profissional
        </p>
        <h2 className="font-display text-4xl sm:text-5xl text-navy leading-tight mb-6">
          {DOCTOR.name},<br />
        ...
        <a
          ...
          className="inline-flex items-center gap-3 px-7 py-4 rounded-full bg-navy text-white font-medium hover:bg-navy-deep transition-colors duration-300 shadow-soft"
        >
